// MPU-6050 Accelerometer + Gyro + LCD 1602
// -----------------------------
//
// By arduino.cc user "Krodal".
// June 2012/2013: https://playground.arduino.cc/Main/MPU-6050/

// Open Source / Public Domain

// Modified by Debra 2015 - http://www.geekmomprojects.com/gyroscopes-and-accelerometers-on-a-chip/
// Modified by Eden33 2019 - https://github.com/Eden33/arduino-playground
// 
// Using Arduino 1.0.1
...
{      
  ...
  /* Initialize the Wire library of the Arduino and join 
  the I2C bus as a master. */
  Wire.begin();
  ...
  */
  ...
  // set up the LCD and print initial information
  lcd.begin(16, 2);
  lcd.setCursor(0,0);
  lcd.print("X axis deg: 0");
  lcd.setCursor(0,1);
  lcd.print("Y axis deg: 0");
}
...
void loop()
{
  ...
  */
  ...
  // output current x & y axis degrees to LCD display
  char buffer[3];
  lcd.setCursor(12, 0);
  sprintf(buffer, "%-3i", (int) angle_x);
  lcd.print(buffer);
  lcd.setCursor(12, 1);
  sprintf(buffer, "%-3i", (int) angle_y);
  lcd.print(buffer);
